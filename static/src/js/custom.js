odoo.define('adev_profile.VariantMixinCustom', function (require) {
    'use strict';
    ...
    VariantMixin._getCombinationInfo = function (ev) {
        ...
        if ($parent.hasClass('main_product')) {
            ...
            for (const optionalProduct of $optProducts) {
                ...
                const originalTemplateId = parseInt($currentOptionalProduct.find('.original_template_id').val());
                console.log(originalTemplateId);
                const isFromPack = $currentOptionalProduct.find('.product_from_pack').val();
                console.log(isFromPack);
            ...
            // originalTemplateId = parseInt($currentOptionalProduct.find('.original_template_id').val());
            // isFromPack = $currentOptionalProduct.find('.product_from_pack').val();
        }
    ...
    // console.log(VariantMixinCustom);

    // VariantMixinCustom.include({
    //     /**
    //      * @see onChangeVariant
    //      *
    //      * @private
    ...
    // var MyCustomMixin = VariantMixinCustom.extend({
    //     events: {
